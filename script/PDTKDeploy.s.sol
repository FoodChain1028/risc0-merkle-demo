...
import {PrivateDataToken} from "../contracts/PrivateDataToken.sol";
...
contract PrivateDataTokenDeploy is Script {
    ...
    function run() external {
        ...
        PrivateDataToken privateDataToken = new PrivateDataToken(verifier);
        console2.log("Deployed PrivateDataToken to", address(privateDataToken));
